...
<h3 class="heading text-center mb-sm-5 mb-3">View Note</h3>
<p>
...
<form name="form1" method="post" action="">
  ...
  <table width="1021" height="130" border="0" align="center">
    ...
    <?php
	$qrys1="select * from  add_note";
		$result = $conn->query($qrys1);
		while($row = $result->fetch_assoc())
		{
		 ?>
    <tr>
      <td><div align="center"><?php echo $row['com_name'];?></div></td>
      <td><div align="center"><?php echo $row['contact'];?></div></td>
      <td><div align="center"><?php echo $row['address'];?></div></td>
      <td><div align="center"><a href="Upload/<?php echo $row['file'];?>" target="_blank">View</a></div></td>
