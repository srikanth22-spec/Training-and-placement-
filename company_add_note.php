...
$id=$sid+1; 
$rdate=date("D-M-y");
$update="insert into add_note values($id,'$uname','$name2','$contact2','$address','$photon','$description','$rdate')";
if ($conn->query($update) === TRUE)  
{
move_uploaded_file($_FILES['file']['tmp_name'],"Upload/".$photon);
?>					
<script language="javascript">
alert("Notes Add Success");
window.location.href="company_accept_invite.php";
</script>
<?php
}
else
...
<h3 class="heading text-center mb-sm-5 mb-3">Add Notes </h3>
<p>
 
</p>
<form name="form1" method="post" action="" enctype="multipart/form-data">
 
  <table width="493" height="185" border="0" align="center">
    <tr>
      <td width="120"><div align="center">File :</div></td>
